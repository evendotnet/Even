...
let githubLink = "http://github.com/EvenDotNet/Even"

// Specify more information about your project
let info =
  [ "project-name", "Even"
    "project-author", "nvivo"
    "project-summary", "An event sourcing framework on top of Akka.NET"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/Even" ]
