...
//        public async Task ReadStreamAsync(Stream stream, int initialSequence, int maxEvents, Action<IPersistedRawEvent> readCallback, CancellationToken ct)
//        {
...
//        public async Task ReadIndexedProjectionStreamAsync(Stream stream, int initialSequence, int maxEvents, Action<IPersistedRawEvent> readCallback, CancellationToken ct)
//        {
//            var streamHash = StreamHash.AsHashBytes(streamId);
...
//                        initialSequence++,
//                        Format(e.EventID),
//                        e is IUnpersistedRawStreamEvent ? Format(StreamHash.AsHashBytes(((IUnpersistedRawStreamEvent)e).Stream)) : streamHash,
//                        e is IUnpersistedRawStreamEvent ? EscapeString(((IUnpersistedRawStreamEvent)e).Stream) : null,
